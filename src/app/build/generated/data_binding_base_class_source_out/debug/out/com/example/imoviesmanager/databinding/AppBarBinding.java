...
public final class AppBarBinding implements ViewBinding {
  ...
  private AppBarBinding(@NonNull CoordinatorLayout rootView, @NonNull FloatingActionButton fav,
  ...
  public static AppBarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.fav;
      FloatingActionButton fav = rootView.findViewById(id);
      if (fav == null) {
        break missingId;
      }
      ...
      return new AppBarBinding((CoordinatorLayout) rootView, fav, toolbar);
    }
