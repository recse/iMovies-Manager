...
public class SignUpActivity extends AppCompatActivity {
    ...
    //Se crea la variable de autentificacion de Firebase
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Recibimos información de Firebase, donde se determinará el status del usuario (registrado o NO registrado.
        mAuth = FirebaseAuth.getInstance();
    }

        //Creamos la función para validar si el registro del usuario e introducimos limitaciones y requisitos a la hora de crear el usuario.
    ...
    //Método de registro manual. Pasamos el método .createUser
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent(SignUpActivity.this, InicioActivity.class);
                            startActivity(intent);
                            finish();
                        } else {
                            Toast.makeText(SignUpActivity.this, "Fallo a la hora de registrarse", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
